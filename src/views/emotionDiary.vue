            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryForm.emotionTrigger" placeholder="今天什么事情影响了你的情绪?" type="textarea" :rows="3" maxlength="1000" show-word-limit></el-input>
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryForm.diaryContent" placeholder="写下你今天的想法，感受或发生的有趣的事情..." type="textarea" :rows="5" maxlength="2000" show-word-limit></el-input>
                    </div>
                    <!-- 生活指标 -->
